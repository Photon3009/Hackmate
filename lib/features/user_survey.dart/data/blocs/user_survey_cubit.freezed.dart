...
/// @nodoc
abstract class _$$UserSurveyStateImplCopyWith<$Res>
    implements $UserSurveyStateCopyWith<$Res> {
  factory _$$UserSurveyStateImplCopyWith(_$UserSurveyStateImpl value,
          $Res Function(_$UserSurveyStateImpl) then) =
      __$$UserSurveyStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<String> selectedSkills,
...
/// @nodoc
class __$$UserSurveyStateImplCopyWithImpl<$Res>
    extends _$UserSurveyStateCopyWithImpl<$Res, _$UserSurveyStateImpl>
    implements _$$UserSurveyStateImplCopyWith<$Res> {
  __$$UserSurveyStateImplCopyWithImpl(
      _$UserSurveyStateImpl _value, $Res Function(_$UserSurveyStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UserSurveyStateImpl(
      selectedSkills: null == selectedSkills
...
/// @nodoc
@JsonSerializable()
class _$UserSurveyStateImpl implements _UserSurveyState {
  const _$UserSurveyStateImpl(
  ...
  factory _$UserSurveyStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$UserSurveyStateImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UserSurveyStateImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UserSurveyStateImplCopyWith<_$UserSurveyStateImpl> get copyWith =>
      __$$UserSurveyStateImplCopyWithImpl<_$UserSurveyStateImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserSurveyStateImplToJson(
      this,
    );
  }
}
...
abstract class _UserSurveyState implements UserSurveyState {
  const factory _UserSurveyState(
      ...
      final String? selectedHackathonType,
      final String? teamMemberPreferredLocation}) = _$UserSurveyStateImpl;

  factory _UserSurveyState.fromJson(Map<String, dynamic> json) =
      _$UserSurveyStateImpl.fromJson;
