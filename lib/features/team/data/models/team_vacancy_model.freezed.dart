...
/// @nodoc
abstract class _$$TeamVacancyImplCopyWith<$Res>
    implements $TeamVacancyCopyWith<$Res> {
  factory _$$TeamVacancyImplCopyWith(
          _$TeamVacancyImpl value, $Res Function(_$TeamVacancyImpl) then) =
      __$$TeamVacancyImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: '\$id') String id,
...
/// @nodoc
class __$$TeamVacancyImplCopyWithImpl<$Res>
    extends _$TeamVacancyCopyWithImpl<$Res, _$TeamVacancyImpl>
    implements _$$TeamVacancyImplCopyWith<$Res> {
  __$$TeamVacancyImplCopyWithImpl(
      _$TeamVacancyImpl _value, $Res Function(_$TeamVacancyImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$TeamVacancyImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$TeamVacancyImpl implements _TeamVacancy {
  const _$TeamVacancyImpl(
  ...
  factory _$TeamVacancyImpl.fromJson(Map<String, dynamic> json) =>
      _$$TeamVacancyImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TeamVacancyImplCopyWith<_$TeamVacancyImpl> get copyWith =>
      __$$TeamVacancyImplCopyWithImpl<_$TeamVacancyImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$TeamVacancyImplToJson(
      this,
    );
  }
}
...
abstract class _TeamVacancy implements TeamVacancy {
  const factory _TeamVacancy(
      ...
      @JsonKey(name: 'join_requests')
      required final List<String> joinRequests}) = _$TeamVacancyImpl;

  factory _TeamVacancy.fromJson(Map<String, dynamic> json) =
      _$TeamVacancyImpl.fromJson;
