...
class HackmateMultiSelector<T> extends StatefulWidget {
  const HackmateMultiSelector._({
    super.key,
    required this.items,
  ...
  factory HackmateMultiSelector.grid({
  ...
  @override
  State<HackmateMultiSelector<T>> createState() =>
      _CodeSwipeMultiSelectorState();
}

class _CodeSwipeMultiSelectorState<T> extends State<HackmateMultiSelector<T>> {
